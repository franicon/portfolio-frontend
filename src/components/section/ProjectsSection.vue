  ...
  <section>
    ...
    <div class="flex flex-col py-44">
      ...
      <div class="mt-16 flex">
        <div class="">
          <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 sm:grid-cols-1 gap-8">
            <template v-for="project in projects" :key="project.title">
              <div class="font-light relative group overflow-hidden border border-zinc-800 shadow-2xl shadow-cyan-800/20 cursor-pointer"
                ...
                <div
                  ...
                  <div class="absolute bottom-8 mx-4">
